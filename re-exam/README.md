# Re-Exam Instructions

The re-exam has the same form as the exam. _The descriptions of methods m1 and m2 are slightly different (you now have to compute averages for m1, and the parameter of m2 is to be doubled), so read them carefully!_
...
An assignment will be opened on Blackboard for handing in the project. The deadline for uploading the project on Blackboard will be: 12 August 2018 at midnight.
